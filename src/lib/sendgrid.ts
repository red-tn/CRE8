    ...
    html: `
      <div style="background-color: #000; color: #fff; padding: 40px; font-family: Arial, sans-serif;">
        <div style="max-width: 600px; margin: 0 auto;">
          <h1 style="color: #f59e0b; text-align: center; font-size: 32px; margin-bottom: 20px;">
            CRE8 TRUCK CLUB
          </h1>
          <h2 style="color: #fff; text-align: center;">Membership Dues Reminder</h2>
          <p style="color: #ccc; font-size: 16px; line-height: 1.6;">
            Hey ${memberName},
          </p>
          <p style="color: #ccc; font-size: 16px; line-height: 1.6;">
            Your CRE8 Truck Club membership dues are coming up on <strong style="color: #f59e0b;">${dueDate}</strong>.
          </p>
          <p style="color: #ccc; font-size: 16px; line-height: 1.6;">
            Keep your membership active to continue enjoying:
          </p>
          <ul style="color: #ccc; font-size: 16px; line-height: 1.8;">
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="${paymentLink}" style="background-color: #f59e0b; color: #000; padding: 15px 40px; text-decoration: none; font-weight: bold; font-size: 18px; border-radius: 4px;">
              PAY DUES NOW - $50
            </a>
          </div>
    ...
    html: `
      <div style="background-color: #000; color: #fff; padding: 40px; font-family: Arial, sans-serif;">
        <div style="max-width: 600px; margin: 0 auto;">
          ...
          <h2 style="color: #fff; text-align: center;">Welcome to the Family!</h2>
          <p style="color: #ccc; font-size: 16px; line-height: 1.6;">
          ...
          <div style="text-align: center; margin: 30px 0;">
            <a href="${loginLink}" style="background-color: #f59e0b; color: #000; padding: 15px 40px; text-decoration: none; font-weight: bold; font-size: 18px; border-radius: 4px;">
